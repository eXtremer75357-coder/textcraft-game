...
- **Interactive Gameplay**: Make choices and battle enemies
- **Boss Fight**: Defeat the Void Dragon in an epic final battle
- **Simple Controls**: Use keyboard input to navigate and interact
